...
- `ParameterHeavy20` uses 20 terms. Wist path uses pre-bound locals (`let`) because current high-performance `DynamicMethodInvoker` helpers in-repo are specialized for up to 11 arguments.
