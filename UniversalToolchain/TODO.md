...
It's bad for the predictability and determinism.
...
## 2. Remove extra boilerplate code
...
## 5. Fix BasicCoreImpl
1. Fix abstractions and its leaks
...
2. Add semantic and syntax checkers
...
3. Add docs.md (or another name) for documentation of difficult algorithms 
...
## 12. Use reflection only via one 'center' (DI or singleton)

## 13. Analyze code-base for bugs
...
1. Make DSL or use ANTLR (some another) to use different parsers (O(n), O(2^n), ALL(*), LR(), etc)
