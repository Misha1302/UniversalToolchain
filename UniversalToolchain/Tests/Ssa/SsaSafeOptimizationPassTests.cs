...
public sealed class SsaSafeOptimizationPassTests
{
    [Test]
    public void ConstantMaterializerAndReaderRoundTripFloat64()
    {
        ...
        Assert.That(constant.Type, Is.EqualTo(SsaSemanticTypes.Float64));
    ...
    public void DeadPureInstructionEliminationKeepsMayThrowCalls()
    {
        var descriptors = new SemanticDescriptorSet(
            types:
            [
                new SemanticTypeDescriptor(SsaSemanticTypes.Int32)
            ],
            callables:
            [
