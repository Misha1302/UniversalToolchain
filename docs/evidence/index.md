...
Use the [Maintainer and Release Guide](/evidence/maintainer-guide) to synchronize documentation, package evidence, version records, manifests and clean artifacts.
