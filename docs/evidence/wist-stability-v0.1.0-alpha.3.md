---
title: Wist 0.1.0-alpha.3 Stability
description: Public package contract after runtime-boundary and release-gate hardening.
---

# Wist 0.1.0-alpha.3 stability

`UniversalToolchain.Wist` `0.1.0-alpha.3` is suitable for controlled evaluation and prototypes. It is not a stable 1.0 contract.
