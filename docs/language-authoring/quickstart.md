...
The generic SDK package family is currently verified as release artifacts at version `0.3.0-alpha.2`; only the Wist facade is documented as published on NuGet.org. Build or obtain the release package directory first.
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="UniversalToolchain.LanguageAuthoring" Version="0.3.0-alpha.2" />
    <PackageReference Include="UniversalToolchain.LanguageSdk" Version="0.3.0-alpha.2" />
    <PackageReference Include="UniversalToolchain.Runtime" Version="0.3.0-alpha.2" />
  </ItemGroup>
</Project>
```
