...
The canonical template package version for this alpha is `0.3.0-alpha.3`. The generic SDK family is currently documented as produced release artifacts rather than as a guaranteed NuGet.org publication.
