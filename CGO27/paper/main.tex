...
Generative AI tools assisted with drafting and revising manuscript text, generating and reviewing code and analysis scripts, and adversarial consistency checking. The human authors selected the research questions, fixed the claim boundaries, executed and inspected the reported workflows, manually checked the cited primary sources, and remain responsible for every claim, experiment, citation, and artifact. The tools are not authors and are not counted as independent external evaluators.
\input{references}
\end{document}
