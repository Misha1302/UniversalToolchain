...
public class WistRuntimeManifestMetadataValidationTests
{
    ...
    public void ManifestEmitter_DoesNotWriteDialectFamilyField()
    {
        ...
        var emitterProject = Path.Combine(repoRoot, "src", "Dialects", "UniversalToolchain.Dialects.ManifestEmitter", "UniversalToolchain.Dialects.ManifestEmitter.csproj");
    ...
    {
        var testDir = TestContext.CurrentContext.TestDirectory;
        var sourcePath = Path.GetFullPath(Path.Combine(testDir, "..", "..", "..", "..", "src", "Dialects", "UniversalToolchain.Dialects.ManifestEmitter", "Program.cs"));
        var source = File.ReadAllText(sourcePath);
    ...
    private static string GetDialectPath(string dialectName) => Path.GetFullPath(Path.Combine(TestContext.CurrentContext.TestDirectory, "..", "..", "..", "..", "samples", "dialects", "wist", dialectName, "dialect.wistdialect"));
