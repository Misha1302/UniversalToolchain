...
```bash
dotnet run --project apps/Wist.Cli/Wist.Cli.csproj -- dialect-inspect --file samples/dialects/wist/restricted-sandbox/dialect.wistdialect
dotnet run --project apps/Wist.Cli/Wist.Cli.csproj -- run --dialect-file samples/dialects/wist/restricted-sandbox/dialect.wistdialect --file samples/dialects/wist/restricted-sandbox/program.wist --mode interpreter
dotnet run --project apps/Wist.Cli/Wist.Cli.csproj -- run --dialect-file samples/dialects/wist/restricted-sandbox/dialect.wistdialect --file samples/dialects/wist/restricted-sandbox/forbidden-program.wist --mode interpreter
dotnet run --project apps/Wist.Cli/Wist.Cli.csproj -- run --dialect-file samples/dialects/wist/restricted-sandbox/dialect.wistdialect --file samples/dialects/wist/restricted-sandbox/forbidden-interop.wist --mode interpreter
```
