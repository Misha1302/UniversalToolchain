...
The former generic runtime-host/runtime-profile compatibility topology was retired in S13. Runtime-manifest emission metadata may remain, but it is not a Wist planner, selector or execution host.
