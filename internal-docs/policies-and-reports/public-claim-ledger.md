...
| Wist facade alpha exists | `UniversalToolchain.Wist`, package smoke tests, `docs/evidence/wist-stability-v0.1.0-alpha.1.md` | Observed code/tests/docs | "`UniversalToolchain.Wist` is a alpha first-contact facade for formula evaluation, validation and typed compiled invocation" | "stable 1.0 formula platform" |
